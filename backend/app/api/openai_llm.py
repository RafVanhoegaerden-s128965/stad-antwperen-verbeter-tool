...
def get_suggestions_stream(text: str, text_type: TextType):
                    ...
                    "corrections": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                # LLMs can't count but this should push it to make sure "incorrect_part" is sourced from the text letter by letter
                                "start_index": {
                                    "type": "integer",
                                    "description": "The starting character index of the incorrect part within the full text."
                                },
                                "end_index": {
                                    "type": "integer",
                                    "description": "The ending character index of the incorrect part within the full text."
                                }
                            },
                            "required": [
                                "rule_reference",
...
def get_suggestions(text: str, text_type: TextType):
    ...
    output = ""
    for content in get_suggestions_stream(input, TextType.article):
        output += content
